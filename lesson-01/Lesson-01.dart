#import('dart:html');
#import('../../glmatrix.dart/glmatrix.dart');
...
class Lesson01 {
  ...
  void _setMatrixUniforms() {
    _gl.uniformMatrix4fv(_uPMatrix, false, _pMatrix.dest);
    _gl.uniformMatrix4fv(_uMVMatrix, false, _mvMatrix.dest);
  }
